---
title: "Permutation tests for general dependent truncation -- illustration of the `permDep` function"
...
The `simDat1` funciton generates monotone dependence model and is used in @chiou2018permutation in the absence of censoring. 
...
```{R minp2-2, cache = TRUE}
permDep(dat$Trun, dat$Time, 500, minp2Only = TRUE, minp.eps = "in",
